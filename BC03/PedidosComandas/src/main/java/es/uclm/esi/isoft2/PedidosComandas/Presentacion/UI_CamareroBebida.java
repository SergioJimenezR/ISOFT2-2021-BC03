...
public class UI_CamareroBebida {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UI_CamareroBebida window = new UI_CamareroBebida();
	...
	private void initialize() {
		...
		frmUicocinero.setTitle("UI_CamareroBarra");
		...
		frmUicocinero.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		{
			...
			panel.setLayout(null);
			{
				...
				{
					cbMesasCamareroBarra = new JComboBox();
					cbMesasCamareroBarra.setModel(new DefaultComboBoxModel(new String[] {"Mesa 1", "Mesa 3", "Mesa 4"}));
					cbMesasCamareroBarra.setBounds(156, 36, 233, 21);
					panel_1.add(cbMesasCamareroBarra);
				}
			}
			{
				lblBebidas = new JLabel("Bebidas");
				lblBebidas.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 18));
				lblBebidas.setBounds(21, 10, 91, 13);
